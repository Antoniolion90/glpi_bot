...
URL_GLPI = config('URL_GLPI')
APPTOKEN_GLPI = config('APPTOKEN_GLPI')
...
STATUS_GLPI = {1: 'Новый', 2: 'В работе (начначено)', 3: 'В работе (запланирована)', 4: 'Ожидающие', 5: 'Pешена', 6: 'Закрыто'}
